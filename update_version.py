...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright [bv], " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/BizzareDelay2014-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay2014-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay2014-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay2014-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay2014-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay2014-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/BizzareDelay2014-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/BizzareDelay2014.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BizzareDelay2014.iss",inplace=1):
